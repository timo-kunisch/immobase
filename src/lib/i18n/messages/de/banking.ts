...
export const banking = {
	...
	"allocate.groupHousingCharges": "Offene Hausgeld-Sollstellungen",
	...
	"errors.allocationTargetRequired": "Zeile {index}: Bitte genau ein Zuordnungsziel (Konto, Sollstellung oder Hausgeld) angeben.",
	...
	"errors.housingChargeNotFound": "Die Hausgeld-Sollstellung wurde nicht gefunden.",
	"errors.housingChargeWrongProperty": "Die Hausgeld-Sollstellung gehört zu einer anderen Liegenschaft als die Banktransaktion.",
	"errors.housingChargeCancelled": "Stornierte Hausgeld-Sollstellungen können nicht zugeordnet werden.",
