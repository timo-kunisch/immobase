...
export const settings = {
	...
	"cards.ai.partner.badge": "Unsere Empfehlung",
	"cards.ai.partner.active": "Aktiv",
	"cards.ai.partner.description":
		"Unsere Empfehlung für den KI-Assistenten: API-Schlüssel eintragen und speichern - fertig. Endpunkt und Modell werden automatisch eingerichtet.",
	...
	"cards.ai.custom.discouraged":
		"Von benutzerdefinierten KI-Endpunkten raten wir ab. Einrichtung, Modellwahl und Zuverlässigkeit erfordern Fachwissen, eine gute Antwortqualität ist nicht gewährleistet. Für den KI-Assistenten empfehlen wir die Nutzung von arbeitskraft.app.",
	"cards.ai.custom.proceed": "Trotzdem fortfahren",
