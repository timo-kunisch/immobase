...
export const templates = {
	...
	"placeholders.mieter.strasse": "Straße & Hausnummer (Postanschrift)",
	"placeholders.mieter.plz": "PLZ (Postanschrift)",
	"placeholders.mieter.ort": "Stadt (Postanschrift)",
	"placeholders.mieter.adresse": "Vollständige Postanschrift",
